...
- you already have a Moose drive, i.e. ST3500320AS or ST31000340AS, that is on an SDxA firmware version or later. The use of "x" is necessary because four differentfirmware branches exist which all end at an SDxA version.
